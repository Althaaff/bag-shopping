      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            >
              <TbBrandMeta className="h-5 w-5 font-bold" />
            </a>
            ...
            <a
              ...
              className="hover:text-gray-300"
            >
              <IoLogoInstagram className="h-5 w-5 font-bold" />
            </a>
            ...
            <a
              ...
              className="hover:text-gray-300"
            >
              <RiTwitterXLine className="h-5 w-5 font-bold" />
            </a>
          </div>
          <p className="text-gray-500">Call Us</p>
          <p>
            <FiPhoneCall className="h-5 w-5 font-bold inline-block mr-2" />
            0123-456-789
          </p>
        </div>
      </div>
